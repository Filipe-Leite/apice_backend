class SubtopicsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @subtopic.update(subtopic_params)
        format.html { redirect_to @subtopic, notice: "Subtopic was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to subtopics_path, notice: "Subtopic was successfully destroyed.", status: :see_other }
